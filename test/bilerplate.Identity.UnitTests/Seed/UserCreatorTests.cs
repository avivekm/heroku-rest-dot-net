using bilerplate.Identity.Seed;
using bilerplate.Identity.UnitTests.Fakes;
using bilerplate.Identity.UnitTests.Mocks;
using Moq;
using System;
...
namespace bilerplate.Identity.UnitTests.Seed
{
